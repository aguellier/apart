=======================================================
``measure_general_efficiency`` --- Measure Performances
=======================================================

.. automodule:: measure_general_efficiency
...
downloaded :download:`here <../../examples/measure_general_efficiency.py>`.
...
* One plotting function for each metric computed by the module. Each such
  ...
  * The function :func:`plot_HIST_NB_LINK_MSGS_SENT_PER_ROUND` is not decorated,
    because it is not a *simple metric* but an histogram.
...
.. literalinclude:: ../../examples/measure_general_efficiency.py
